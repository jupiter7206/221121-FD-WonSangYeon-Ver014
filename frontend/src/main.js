...
pluralCaseList.push( {plural: "결재", pascal: "결재"} )

pluralCaseList.push( {plural: "주문처리", pascal: "주문처리"} )

pluralCaseList.push( {plural: "배달관리", pascal: "배달관리"} )

pluralCaseList.push( {plural: "알림", pascal: "알림"} )

pluralCaseList.push( {plural: "메뉴선택Preferences", pascal: "메뉴선택Preference"} )
